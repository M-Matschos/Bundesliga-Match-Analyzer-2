...
**Scope-Entscheidung (2026-05-11): Explizit out-of-scope für aktuellen Release.**

Vorhandene Struktur: Electron + React-App (`match-oracle-desktop` v1.0.0), `main.js` als Electron-Einstieg, `src/` mit 4 Komponenten (`App.jsx`, `Dashboard.jsx`, `MatchList.jsx`, `WeekendCalculator.jsx`). Build-Output in `dist/` vorhanden.

Integrations-Status: 4 Dateien mit API/Auth-Referenzen, aber Vertragskonformität mit aktuellem Backend nicht verifiziert, kein Auth-Flow-Test durchgeführt.

Für nächsten Release klären: Auth-Integration, API-Vertrag-Abgleich, Build-Pipeline, Testabdeckung.
