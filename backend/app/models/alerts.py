...
from sqlalchemy import Column, String, DateTime, Float, Boolean, Integer, Text, Enum as SQLEnum
...
class NewsAlert(Base):
    ...
    user_acted_count = Column(Integer, default=0)  # Wie viele Nutzer haben Aktion getroffen?
