...
class APIFootballCollector:
    ...
    async def get_fixtures(
        ...
        logger.debug("get_fixtures league=%s date_from=%s date_to=%s", league_id, date_from, date_to)
    ...
    async def get_fixtures_by_matchday(
        ...
        logger.debug("get_fixtures_by_matchday league=%s matchday=%s", league_id, matchday)
