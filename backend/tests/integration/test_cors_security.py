...
class TestCORSConfiguration:
    ...
    def test_cors_methods_explicit_not_wildcard(self):
        ...
        assert isinstance(settings.cors_allow_methods, str) or isinstance(settings.cors_allow_methods, list)
    ...
    def test_cors_headers_explicit_not_wildcard(self):
        ...
        # Should be comma-separated or list
        assert isinstance(settings.cors_allow_headers, str) or isinstance(settings.cors_allow_headers, list)
