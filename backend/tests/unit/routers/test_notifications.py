...
class TestNotificationsRouterPrefix:
    ...
    def test_notifications_endpoint_exists_at_correct_prefix(self):
    ...
    def test_notifications_wrong_prefix_returns_404(self):
    ...
    def test_notifications_register_device_at_correct_prefix(self):
    ...
    def test_notifications_subscribe_at_correct_prefix(self):
